...
class StockAPIClientBase:
    ...
    def __init__(self):
        ...
        # _client_session:(aiohttp.ClientSession) = aiohttp.ClientSession(raise_for_status=True)
    ...
    def url_from_endpoint(self, endpoint: str) -> str:
        url = self._base_url_ if self._base_url_.endswith("/") else self._base_url_ + "/"
    ...
    def _get_ticker_json_data( self,
        ticker:str=None
    ):
    ...
    def get_multiple_tickers_json_data(
        self,
        tickers:List[str]=[]
    ):
